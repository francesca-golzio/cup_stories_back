...
<div class="container d-flex flex-wrap gap-5">
  ...
  <div class="card bg-secondary-subtle p-2" style="width: 200px; aspect-ratio: 3/2;">
    ...
    <div class="card-body bg-light rounded d-flex justify-content-between">
      <a href="{{ route('admin.issues.index') }}" class="btn btn-info m-1">lista</a>
      <a href="{{ route('admin.issues.create') }}" class="btn btn-success m-1">nuovo</a>
    </div>
  </div>
  ...
  <div class="card bg-secondary-subtle p-2" style="width: 200px; aspect-ratio: 3/2;">
    ...
    <div class="card-body bg-light rounded d-flex justify-content-between">
      <a href="{{ route('admin.authors.index') }}" class="btn btn-info m-1">lista</a>
      <a href="{{ route('admin.authors.create') }}" class="btn btn-success m-1">nuovo</a>
    </div>
  </div>
  ...
  <div class="card bg-secondary-subtle p-2" style="width: 200px; aspect-ratio: 3/2;">
    ...
    <div class="card-body bg-light rounded d-flex justify-content-between">
      ...
      <a href="{{ route('admin.tags.create') }}" class="btn btn-success m-1">nuovo</a>
    </div>
  </div>
