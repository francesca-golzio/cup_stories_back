    ...
    <div class="d-flex align-items-center gap-3">
      <div>
        ...
        <div class="form-group my-3">
          <button type="submit" class="form-control btn btn-success" name="set_status" value="save_draft">Save as draft</button>
        </div>
        @endif
        @if ($issue->status == 'published')
        <div class="form-group my-3">
          <button type="submit" class="form-control btn btn-success" name="set_status" value="unpublish">Unpublish and Save as draft</button>
        </div>
        @endif
      </div>
      ...
      <div class="form-group my-3">
        <button type="submit" class="form-control btn btn-success" name="set_status" value="publish">Publish the updated Issue</button>
      </div> <!-- QUI bisognerebbe usare ?? una modale per confermare la pubblicazione -->
